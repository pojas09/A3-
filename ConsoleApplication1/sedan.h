...
class Sedan : public Carro {
	...
	// Construtores
	Sedan() : Carro("", "", "", 2023, 0, "", 0, 0, 0, false) {}
	Sedan(const string& modelo, const string& tipoCarro, const string& cor, const int& ano, const float& preco, const string& placa, const int& potencia, const int& bagagem, const float& gasolina, const bool& gps)
	: Carro(modelo, tipoCarro, cor, ano, preco, placa, potencia, bagagem, gasolina, gps) {}

	string getNomeModeloSedan(ModeloSedan modeloEscolhido) {
